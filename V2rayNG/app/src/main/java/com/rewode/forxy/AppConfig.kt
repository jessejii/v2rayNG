...
object AppConfig {
    ...
    /** Broadcast actions. */
    const val BROADCAST_ACTION_SERVICE = "com.rewode.forxy.action.service"
    const val BROADCAST_ACTION_ACTIVITY = "com.rewode.forxy.action.activity"
    const val BROADCAST_ACTION_WIDGET_CLICK = "com.rewode.forxy.action.widget.click"
